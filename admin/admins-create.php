               ...
               <form action="process.php" method="POST" enctype="multipart/form-data">
                  <div class="row">
                        ...
                        <div class="form-check">
                                <input type="checkbox" class="form-check-input " name="status" style="width: 20px; height:20px;">
                        ...
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <button type="submit" name="saveAdmin" class="btn btn-primary px-4">Add</button>

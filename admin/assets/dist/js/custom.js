            ...
            success: function (res) {
                ...
                if (res.status == 200) {
                    ...
                    document.getElementById('printButton').addEventListener('click', function () {
                        // Redirect to the view-invoice.php page with the invoice ID as a parameter
                        window.location.href = 'view-invoice.php?invoice=' + res.invoice_id;
                        // Optionally, you can add code to print the content here (e.g., using window.print()).
                    });
                    ...
                    Swal.fire("Customer Not Found!", "Please add a customer!", "warning");
                }
            }
